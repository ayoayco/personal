...
<html lang="en">
  <head>
    ...
    <title>Ayo Ayco | Identity Test</title>
  ...
  <body>
    <div class="container">
      ...
      <form class="form-signin" role="form" action="login.php">
        ...
        <input type="password" class="form-control" placeholder="What's the Password?" required>
        <div class="checkbox">
          <label>
        ...
        <a href="../" class="btn btn-lg btn-danger btn-block">I Give Up</a>
      </form>
